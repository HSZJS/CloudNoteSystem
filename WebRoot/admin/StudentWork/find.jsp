...
<html>
	...
	<body>
		...
		<form
			action="${pageContext.request.contextPath}/StudentWork-getAllUtil.action">
						...
						<tr>
							...
							<td>								<a
								...
								<c:if test="${type == 'admin'}">
									<a target="Conframe"
										href="${pageContext.request.contextPath}/StudentWork-selectUtil.action?util.id=${tmp.id }">修改
									</a>
									<a target="Conframe"
										href="${pageContext.request.contextPath}/StudentWork-deleteUtil.action?util.id=${tmp.id }">删除
									</a>
								</c:if>
								<c:if test="${type != 'admin'}">
									<a target="Conframe"
										href="${pageContext.request.contextPath}/StudentWork-selectUtil.action?util.id=${tmp.id }">查看
									</a>
								</c:if>
							</td>
						</tr>
