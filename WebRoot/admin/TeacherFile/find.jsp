...
<html>
	...
	<body>
		...
		<form
			action="${pageContext.request.contextPath}/TeacherFile-getAllUtil.action">
						...
						<tr>
							...
							<td>								<a
								...
								<c:if test="${type == 'admin'}">
									<a target="Conframe"
										href="${pageContext.request.contextPath}/TeacherFile-selectUtil.action?util.id=${tmp.id }">修改
									</a>
									<a target="Conframe"
										href="${pageContext.request.contextPath}/TeacherFile-deleteUtil.action?util.id=${tmp.id }">删除
									</a>
								</c:if>
								<c:if test="${type != 'admin'}">
									<a target="Conframe"
										href="${pageContext.request.contextPath}/TeacherFile-selectUtil.action?util.id=${tmp.id }">查看
									</a>
								</c:if>
							</td>
						</tr>
